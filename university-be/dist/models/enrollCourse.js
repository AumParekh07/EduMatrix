...
exports.EnrollCourseSchema = new mongoose_1.default.Schema({
    ...
    universityID: { type: mongoose_1.default.Types.ObjectId, required: true, ref: "university" },
    courseID: { type: mongoose_1.default.Types.ObjectId, required: true, ref: "course" },
